  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <section className="py-16 md:py-24">
        <div className="container mx-auto px-4 md:px-6">
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center max-w-6xl mx-auto">
                  ...
                  <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-4 border border-white/20">
                    <div className="flex items-center gap-3">
                      <div className="flex -space-x-2">
                        <div className="w-8 h-8 rounded-full bg-brand-teal flex items-center justify-center text-white text-xs font-bold border-2 border-white">R</div>
                        <div className="w-8 h-8 rounded-full bg-brand-gold flex items-center justify-center text-white text-xs font-bold border-2 border-white">P</div>
                      ...
                      <p className="text-white text-sm font-medium">Join 10,000+ families who trust us</p>
                    </div>
                  </div>
                </div>
              </div>
              {/* Floating Badge */}
              <div className="absolute -top-4 -right-4 md:-right-6 bg-white p-4 rounded-2xl shadow-xl border border-slate-100 hidden md:flex items-center gap-3">
                <div className="bg-green-100 p-2.5 rounded-xl">
                  <CheckCircle2 className="w-6 h-6 text-green-600" />
                </div>
                <div>
                  <p className="text-lg font-bold text-brand-navy font-heading">100%</p>
                  <p className="text-xs text-slate-500 font-medium">Verified Staff</p>
                </div>
              </div>
            </div>
            ...
            {/* Content Side */}
            <div>
              <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-brand-teal/10 text-brand-teal font-semibold text-xs mb-5 border border-brand-teal/20">
                <Building2 className="w-4 h-4" />
                <span>Our Story</span>
              </div>
              <h2 className="text-3xl md:text-4xl font-bold text-brand-navy font-heading mb-6 leading-tight">
              ...
              <div className="space-y-4 text-slate-600 leading-relaxed">
                ...
                <p>
                  Today, we have successfully placed over <strong className="text-brand-navy">15,000 verified professionals</strong> across <strong className="text-brand-navy">10,000+ households</strong> in Mumbai — from Andheri to Borivali, Bandra to Thane, and Navi Mumbai to South Mumbai.
                </p>
              </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="text-center max-w-2xl mx-auto mb-12">
            ...
            <h2 className="text-3xl md:text-4xl font-bold text-brand-navy font-heading mb-3">
          ...
          >
            {values.map((value, idx) => (
              <div key={idx} className="bg-slate-50 rounded-2xl p-6 border border-slate-100 hover:shadow-lg hover:-translate-y-1 transition-all group">
                <div className={`${value.color} p-3 rounded-xl w-fit mb-5 group-hover:scale-110 transition-transform`}>
                  <value.icon className="w-6 h-6" />
                </div>
                <h3 className="text-lg font-bold text-brand-navy font-heading mb-2">{value.title}</h3>
      ...
      <section className="py-16 md:py-20 bg-brand-navy relative overflow-hidden">
        <div className="absolute top-0 right-0 w-[400px] h-[400px] bg-brand-teal/10 rounded-full blur-[100px] -translate-y-1/2 translate-x-1/3"></div>
            ...
            {timeline.map((item, idx) => (
              <div key={idx} className="flex gap-6 mb-8 last:mb-0">
                <div className="flex flex-col items-center">
                  <div className="w-12 h-12 rounded-full bg-brand-teal/20 border-2 border-brand-teal flex items-center justify-center shrink-0">
                    <span className="text-xs font-bold text-brand-teal">{item.year}</span>
                  </div>
      ...
      <section className="py-16 md:py-20 bg-white">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-slate-50 to-brand-teal/5 rounded-3xl p-8 md:p-12 border border-slate-200 text-center relative overflow-hidden">
            <div className="absolute top-0 right-0 w-64 h-64 bg-brand-teal/10 rounded-full blur-3xl -translate-y-1/2 translate-x-1/4"></div>
            <div className="relative z-10">
              <h2 className="text-3xl md:text-4xl font-bold text-brand-navy font-heading mb-4">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/services" className="inline-flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-brand-navy font-bold py-4 px-8 rounded-full border border-slate-200 shadow-sm transition-all">
