      ...
      <main className="flex-grow pt-32 pb-20">
        <div className="container mx-auto px-4 md:px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
            {BLOG_POSTS.map(post => (
              <article key={post.id} className="dark:bg-[#1e293b] bg-white rounded-2xl overflow-hidden shadow-lg border dark:border-white/10 border-slate-100 hover:shadow-2xl hover:-translate-y-1 transition-all duration-300 flex flex-col group">
                ...
                <div className="p-4 md:p-5 flex flex-col flex-grow">
                  ...
                  <div className="mt-auto pt-3 border-t dark:border-white/10 border-slate-100 flex items-center justify-between transition-colors">
                    ...
                    <Link to={`/blog/${post.slug}`} className="text-brand-gold font-bold text-xs flex items-center gap-1 hover:text-amber-500 transition-colors">
