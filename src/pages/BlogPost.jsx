      ...
      <main className="flex-grow pt-24 pb-20">
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <article 
              className="prose prose-lg md:prose-xl prose-slate max-w-none prose-headings:font-heading prose-headings:text-brand-navy prose-h2:text-3xl prose-h3:text-2xl prose-a:text-brand-teal prose-a:font-semibold hover:prose-a:text-teal-600 prose-img:rounded-3xl prose-img:shadow-lg bg-white p-8 md:p-12 lg:p-16 rounded-3xl shadow-sm border border-slate-200"
            ...
            <div className="mt-12 bg-gradient-to-r from-brand-navy to-slate-800 rounded-3xl p-8 text-center text-white relative overflow-hidden shadow-xl">
              ...
              <div className="relative z-10">
                <h3 className="text-2xl font-bold font-heading mb-3">Ready to hire a trusted professional?</h3>
