        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="max-w-3xl mx-auto">
            ...
            <header className="mb-10">
              <div className="flex items-center gap-4 text-sm font-semibold dark:text-slate-400 text-slate-500 mb-6 transition-colors">
              ...
              <h1 className="text-4xl md:text-5xl font-bold dark:text-white text-brand-navy font-heading leading-tight mb-8 transition-colors">
                {post.title}
              </h1>
            ...
            <div className="mt-12 bg-gradient-to-r from-brand-navy to-slate-800 rounded-3xl p-8 text-center text-white relative overflow-hidden shadow-xl">
              ...
              <div className="relative z-10">
                ...
                <Link to="/contact" className="inline-block bg-brand-gold text-white font-bold px-8 py-3.5 rounded-full hover:bg-amber-500 transition-colors shadow-lg">
                  Get Free Call Back
                </Link>
              </div>
            </div>
