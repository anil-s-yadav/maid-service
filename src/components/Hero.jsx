...
export const Hero = () => {
  ...
  return (
    <section className="relative pt-24 pb-12 md:pt-32 md:pb-16 flex items-center overflow-hidden bg-[#0a1128]">
      {/* Background Glows */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-12 gap-8 lg:gap-4 items-center">
          ...
          {/* Left: Text Content */}
          <div ref={titleRef} className={`lg:col-span-7 xl:col-span-8 transition-all duration-1000 ${titleInView ? animations.fadeUp.in : animations.fadeUp.out}`}>
            ...
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/[0.08] backdrop-blur-md border border-brand-gold/30 mb-5 shadow-[0_0_15px_rgba(217,119,6,0.15)]">
              ...
              <span className="text-xs font-bold text-brand-gold tracking-widest uppercase">Mumbai's Premium Agency</span>
            </div>
            ...
            <div className="flex flex-wrap gap-3">
              <div className="flex items-center gap-2 bg-white/[0.06] backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-xl shadow-lg hover:bg-white/[0.1] transition-colors">
                <Shield className="w-4 h-4 text-brand-gold" />
                <span className="text-white text-xs font-bold uppercase tracking-wider">Aadhaar Verified</span>
              </div>
              <div className="flex items-center gap-2 bg-white/[0.06] backdrop-blur-md border border-white/10 px-4 py-2.5 rounded-xl shadow-lg hover:bg-white/[0.1] transition-colors">
                <Star className="w-4 h-4 text-brand-gold" />
                <span className="text-white text-xs font-bold uppercase tracking-wider">3-Day Trained</span>
              </div>
            </div>

          </div>

          {/* Right: Booking Form (Compact Glassmorphism) */}
          <div ref={formRef} className={`lg:col-span-5 xl:col-span-4 relative w-full max-w-[380px] mx-auto lg:ml-auto transition-all duration-1000 delay-300 ${formInView ? animations.scaleUp.in : animations.scaleUp.out}`}>
            <div className="absolute -inset-0.5 bg-gradient-to-b from-brand-gold/50 to-brand-teal/30 rounded-3xl blur-md opacity-40"></div>
            
            <div className="relative bg-[#0a1128]/60 backdrop-blur-xl border border-white/20 rounded-3xl p-6 shadow-2xl">
              <div className="mb-5 text-center">
                <h2 className="text-xl font-bold text-white mb-1 font-heading">Book Free Consultation</h2>
                <p className="text-brand-gold text-[10px] font-bold uppercase tracking-widest">Profiles on WhatsApp in 30 Min</p>
              </div>
              ...
              {submitted ? (
                <div className="text-center py-6">
                  ...
                  <p className="text-slate-300 text-xs">Our team will call you shortly.</p>
                </div>
              ) : (
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <div className="relative">
                    ...
                    <input 
                      ...
                      className="w-full bg-white/[0.05] border border-white/10 text-white text-sm rounded-xl pl-12 pr-4 py-2.5 focus:outline-none focus:border-brand-gold focus:ring-1 focus:ring-brand-gold transition-colors placeholder:text-slate-500"
                    />
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full bg-gradient-to-r from-brand-gold to-amber-500 hover:from-amber-500 hover:to-brand-gold text-brand-navy font-bold py-3 rounded-xl shadow-[0_0_15px_rgba(217,119,6,0.3)] transition-all hover:shadow-[0_0_20px_rgba(217,119,6,0.5)] mt-2 active:scale-[0.98] disabled:opacity-70 text-sm"
                  >
